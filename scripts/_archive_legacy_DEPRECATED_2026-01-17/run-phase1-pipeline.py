...
def main() -> int:
    ...
    enrich_script = _script("pipeline/enrich-open-data.py")
    validate_script = _script("validation/validate-json.py")
    build_index_script = _script("builders/build-index.py")
    missing_report_script = _script("builders/build-missing-report.py")
    progress_script = _script("builders/build-progress.py")
