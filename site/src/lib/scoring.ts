...
export function getTopScores(scores: TourPlanningScores | null | undefined): Array<{label: string, score: number}> {
  if (!scores) return []
...
export function hasAnyScore(scores: TourPlanningScores | null | undefined): boolean {
